...
<!-- 
### Werkwijze verdere ontwikkeling

- Regelmatige werksessies (1x/maand, 2 uur); openbaar; link naar Teams-meeting toevoegen.
- Github Discussions voor vragen en bespreken nieuwe issues.
- Issues worden bijgehouden in Github

-->

### Versiebeheer & publicatie
...
Als laatste stap bij publicatie wordt de IG aangemeld/geüpdated bij de [IG Registry](https://www.fhir.org/guides/registry/) via een pull request naar [Github IG-Registry](https://github.com/FHIR/ig-registry/tree/master).
